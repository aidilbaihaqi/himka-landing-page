        ...
        <div class="space-y-6">
          ...
          <div>
            ...
            <textarea name="description" rows="3" maxlength="500"
              class="w-full px-4 py-2 border border-himka-secondary/20 rounded-lg focus:outline-none focus:border-himka-accent @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
          ...
          <div>
            ...
            <input type="file" name="image" accept="image/jpeg,image/png,image/jpg,image/gif,image/webp" required
            ...
            <p class="text-xs text-himka-secondary/50 mt-1">Format: JPG, JPEG, PNG, GIF, WEBP. Maksimal 2MB. Rekomendasi: 1200x800px atau rasio 3:2 untuk tampilan optimal di carousel.</p>
          </div>
