        ...
        <div class="space-y-6">
          ...
          <div>
            ...
            <textarea name="excerpt" rows="2" maxlength="500"
              class="w-full px-4 py-2 border border-himka-secondary/20 rounded-lg focus:outline-none focus:border-himka-accent @error('excerpt') border-red-500 @enderror">{{ old('excerpt', $article->excerpt) }}</textarea>
          ...
          <div>
            ...
            @if($article->image)
              <div class="mb-3 relative inline-block group">
                <img src="{{ Storage::url($article->image) }}" class="w-40 h-24 object-cover rounded-lg border border-himka-secondary/20" alt="">
          ...
          <div class="bg-himka-cream/50 p-4 rounded-lg space-y-4">
            ...
            <div class="border-t border-himka-secondary/10 pt-4">
              ...
              <div class="space-y-3">
                <label class="flex items-start gap-3 cursor-pointer">
                  <input type="radio" name="is_published" value="0" {{ old('is_published', $article->is_published) == '0' ? 'checked' : '' }}
                ...
                <label class="flex items-start gap-3 cursor-pointer">
                  <input type="radio" name="is_published" value="1" {{ old('is_published', $article->is_published) == '1' ? 'checked' : '' }}
                    class="w-4 h-4 mt-0.5 text-himka-accent border-himka-secondary/20 focus:ring-himka-accent">
                  <div>
